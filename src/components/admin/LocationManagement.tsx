    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-xl sm:text-2xl mb-1 sm:mb-2">Location Management</h2>
            <p className="text-sm sm:text-base text-gray-600">Manage kiosk locations and their configurations</p>
          </div>
          {!isCreating && (
            <button
